...
@dataclass
class DROConfig(TrainingArguments):
    r"""
    DROConfig collects all training arguments related to the [`DROTrainer`] class.
    ...
    """The maximum length of the target. This argument is required if you want to use the default data collator and your model is an encoder-decoder."""
    beta: float = 0.1
    """The beta factor in DRO loss. Higher beta means less divergence from the initial policy."""
